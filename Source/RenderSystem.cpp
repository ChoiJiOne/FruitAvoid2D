...
void RenderSystem::DrawText2D(Font& InFont, const std::wstring& InText, const Vec2i& InPosition0, const Vec2i& InPosition1, const LinearColor& InColor)
{
}

void RenderSystem::DrawText2D(Font& InFont, const std::wstring& InText, const Vec2i& InCenterPosition, int32_t InWidth, int32_t InHeight, const LinearColor& InColor)
{
}
